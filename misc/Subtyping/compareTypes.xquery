...
declare %public function sub:isSubtype($a as xs:string, $b as xs:string) as xs:boolean {
    let $module :=  "xquery version '4.0';
                     ...
                     declare function cmp:compareTypes() as xs:boolean {
                       function() as %TYPE0% {
                         (: circumvent static type checks :)
                         (random-number-generator()?number
                         => string()
                         => xs:QName()
                         => function-lookup(0))()
                       } instance of function() as %TYPE1%
                     };"
...
declare %public function sub:isSubtypeSA($a as xs:string, $b as xs:string) as xs:boolean {
    let $module :=  "xquery version '4.0';
                     module namespace cmp = 'http://www.w3.org/qt4cg/compare-inline';
                     import schema namespace sub = 'http://www.w3.org/XQueryTest/substitution' at 'substitution.xsd';
                     declare namespace p1 = 'http://p1.ns/';
                     declare namespace p2 = 'http://p2.ns/';
                     declare function cmp:compareTypes() as xs:boolean {
                       function() as %TYPE0% {
